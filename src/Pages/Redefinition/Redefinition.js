                ...
                <div className='row mt-4'>
                  <div className='col-sm-6'>
                      <div className='mb-4 title'>
                        Rénitialisation du<br/> mot de passe
                      </div>
                      ...
                      <form className=' mt-4'>
                       <div className='row'>
                            <div className='mb-3'>
                                <input type='password' className='form-field form-control' placeholder='Mot de passe'/>
                            </div>
                            <div className='mb-3'>
                                <input type='password' className='form-field form-control' placeholder='Confirmer Mot de passe'/>
                            </div>
                            <div className='mb-3'>
